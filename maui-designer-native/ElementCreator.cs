...
namespace MAUIDesigner
{
    ...
    internal class GridFactory : ElementFactory
    {
        public override View CreateElement()
        {
            return new Grid
    ...
    internal class VerticalStackFactory : ElementFactory
    {
        public override View CreateElement()
        {
            return new VerticalStackLayout
            {
                ...
                HeightRequest = 140,
                WidthRequest = 200,
                BackgroundColor = Color.FromArgb("#228B7CFF")
            };
        }
    }

    internal class HorizontalStackFactory : ElementFactory
    {
        public override View CreateElement()
        {
    ...
    internal static class ElementCreator
    {
        private static readonly Dictionary<string, ElementFactory> factories = new()
        {
            ...
            { nameof(Grid), new GridFactory() },
            { nameof(VerticalStackLayout), new VerticalStackFactory() },
            { nameof(HorizontalStackLayout), new HorizontalStackFactory() }
        };
